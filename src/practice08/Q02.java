...
public class Q02 {
    public static void main(String[] args) {
        ...
        System.out.println(map1);//{Ferrari=2017, Toyota=2018, Porche=2020, Mercedes=2013, Honda=2021}
        ...
        for (Map.Entry<String,Integer> w : setForm){
            System.out.println("My car is " +w.getKey() +" and the years is " +w.getValue() );
        }
