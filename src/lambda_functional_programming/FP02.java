...
public class FP02 {
   ...
   // between two consecutive elements.
    ...
    public static void printAllElementWithStar(List<Integer> list) {

        list.stream().forEach(Utils::printAllElementWithStar);
