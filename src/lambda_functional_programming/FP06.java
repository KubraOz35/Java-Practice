...
import replitExcercises.AverageValueArray;
...
public class FP06 {
    public static void main(String[] args) {
        ...
        System.out.println(checkNameContainTurkish(coursesList,"Spanish"));
    }
...
//2)Create a method to check if at least one of the course names contains "Turkish" word
    ...
    public static boolean checkNameContainTurkish(List<Courses> list, String word) {
