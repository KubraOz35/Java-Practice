...
public class FP05 {
    public static void main(String[] args) {
        ...
        //burada collection olmamasina ragmen lambda kullandik.List aslinda yok ama intStream() methodu lambda kullanabilmemizi sagliyor.Range() ve rangeClosed()
        //methotlari ile de cikan value lari sanki list gibi siraliyor
