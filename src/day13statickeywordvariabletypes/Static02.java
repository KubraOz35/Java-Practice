...
public class Static02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(obj4.iCounter);//To access "instance variable"you HAVE TO use objects.By using class names it is impossible to access instance variables
