 ...
 package day13statickeywordvariabletypes;
    ...
    public class Static01 {
        ...
        public static void main(String[] args) {//args stands for "arguments"
            ...
            System.out.println("Value of sCounter:" + obj2.sCounter);//Value of sCounter:3
            System.out.println("Value of iCounter:" + obj2.iCounter);//Value of iCounter:1

            System.out.println("Value of sCounter:" + obj1.sCounter);//Value of sCounter:3
            System.out.println("Value of iCounter:" + obj1.iCounter);//Value of iCounter:1

            int age=13;//If you create a variable inside the method it is called "Local Variable"
                       ...
                       //Local variables can not be used outside the method
